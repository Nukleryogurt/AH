...
public class Speler {
    ...
    private SpelerKleur kleur = null;
    private int score;
    ...
    public void setKleur(SpelerKleur spelerKleur) {
        if (!BESCHIKBARE_KLEUREN.contains(spelerKleur)) {
            throw new IllegalArgumentException("De gegeven kleur " + spelerKleur + " is ongeldig.");
        }
    ...
    public void setScore(int score) { // Add setScore method
        this.score = score;
    }
